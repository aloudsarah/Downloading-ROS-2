...
- First Step: Open PowerShell
  ...
  1- Press the Start button (or Windows icon in the corner)
...
```
## Downloading Ubuntu
Type this command in PowerShell to install Ubuntu, make sure it is 22.04 otherwise ROS unable to work
  ```bash
